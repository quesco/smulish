            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            'span',
                            { className: 'clickable filter', 'data-toggle': 'tooltip', title: 'Toggle table filter', 'data-container': 'body' },
...
var ProductList = React.createClass({
    ...
    render: function render() {
        var productNodes = this.props.data.map(function (product, index) {
            return React.createElement(
                SingleProduct,
                { key: index, about: product.about, product: product.product, quantity: product.quantity },
                product.product
            );
        });
        return React.createElement(
            ...
            React.createElement(
                'table',
                { className: 'table table-hover', id: 'dev-table' },
                React.createElement(
                    'thead',
                    null,
                    React.createElement(
...
ReactDOM.render(React.createElement(Products, { url: '/products', pollInterval: 2000 }), document.getElementById('content'));

},{"jquery":29,"react":160,"react-dom":31}],2:[function(require,module,exports){
(function (process){
/**
